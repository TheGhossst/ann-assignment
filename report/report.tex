...
The most useful training graphs for this project are the loss curve and the accuracy curve, because they show how quickly the model converged and whether validation performance stayed close to training performance. The plot below is generated from the real 30-epoch training history saved in \texttt{lenet5\_weights.json}.

\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{../images/training_curves.png}
\caption{Training and validation loss and accuracy over 30 epochs.}
